...
print(f"The original price was ${original_price}, and the current price is ${current_price}. The difference between the current price and the original price is ${increase}, and the percent increase is {percent_increase}%.")
